...
class PsychologistGenderTileWidget extends StatelessWidget {
  const PsychologistGenderTileWidget({
    super.key,
      ...
      builder: (context, value, _) => Column(
        children: [
          RadioGenderTile(
            ...
            onChanged: (value) {
              context.read<GenderTileController>().setGender(GenderEnum.male);
            },
            title: "Male",
          ...
          RadioGenderTile(
            ...
            onChanged: (value) {
              context.read<GenderTileController>().setGender(GenderEnum.female);
            },
            title: "Female",
            value: value.genderEnum,
          ),
